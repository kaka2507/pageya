...
export const Hero03 = ({color, darkMode, title, content}) => {
...
export const Hero03Block = {
    Component: Hero03,
    template: {
        name: 'hero03',
        label: 'Hero03',
        screenshot: 'https://res.cloudinary.com/dku5a4oh9/image/upload/v1605247072/pageya/demo/hero03.png',
